...
class StickersRepositoryImpl implements StickersRepository {
  ...
  Future<void> registerUserSticker(int stickerId, int amount) async {
    try {
      ...
      log('Erro ao inserir figurinha no álbum', error: e, stackTrace: s);
      throw RepositoryException(message: 'Erro ao inserir figurinha no álbum');
    }
  }
  ...
  Future<void> updateUserSticker(int stickerId, int amount) async {
    try {
      ...
      log('Erro ao atualizar figurinha no álbum', error: e, stackTrace: s);
      throw RepositoryException(
          message: 'Erro ao atualizar figurinha no álbum');
    }
  }
}
