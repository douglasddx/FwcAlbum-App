    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            height: 64,
            // OverflowBox não considera as constraints (tamanhos)
            child: OverflowBox(
              maxWidth: double.infinity,
              maxHeight: double.infinity,
              // ClipRect faz o recorte da imagem
              child: ClipRect(
                // Align faz, também, o alinhamento atravpes de fator
                child: Align(
          ...
          Padding(
            ...
            child: Text(
              group.countryName,
              style: TextStyles.i.titleBlack.copyWith(
                fontSize: 26,
              ),
            ),
          ),
          GridView.builder(
            ...
            shrinkWrap: true,
            itemCount: 20,
            // gridDelegate define como os nossos elementos são montados
...
class _Sticker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        color: sticker != null ? ColorsApp.i.primary : ColorsApp.i.gray,
        child: Column(
          children: [
            Container(
            ...
            Text(
              countryCode,
              style: TextStyles.i.textSecondaryFontExtraBold.copyWith(
